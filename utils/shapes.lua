-- https://raw.githubusercontent.com/arndtphillip/dotfiles/master/.config/awesome/lib/shapes.lua
--[[
...
local function create_corner_top_left(args)
    ...
    cr:arc(radius + radius_offset, radius + radius_offset, radius,
    ...
    local function add_stroke(nargs)
        ...
        cr:arc(arc_radius + offset_x, arc_radius + offset_y, arc_radius,
               math.rad(180), math.rad(270))
...
local function create_edge_top_middle(args)
    ...
    -- Inner light stroke
    add_stroke(args.stroke_width_inner, args.stroke_offset_inner,
               args.stroke_color_inner)
    -- Outer dark stroke
    add_stroke(args.stroke_width_outer, args.stroke_offset_outer,
