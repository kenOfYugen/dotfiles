-- https://raw.githubusercontent.com/arndtphillip/dotfiles/master/.config/awesome/lib/border_colors.lua
--[[
...
local function color_darken(color, amount)
    local r, g, b
    r, g, b = gears.color.parse_color(beautiful.xcolor0)
    r = 255 * r
    g = 255 * g
    b = 255 * b
