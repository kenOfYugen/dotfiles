...
local capi = {widget = widget, screen = screen, fake_input = root.fake_input}
...
local function create_button_row(...)
    ...
    for _, i in ipairs(arg) do
        ...
        w:buttons(util.table.join(button({}, 1, nil, function()
    ...
    __call = function(_, pos, scr)
        if not kbd.init then
            kbd.box = wibox({
                ...
                widgets = {
                    {
                        create_button_row("q", "w", "e", "r", "t", "z", "u",
                                          "i", "o", "p", ".")
                    },
                    {
                        create_button_row("a", "s", "d", "f", "g", "h", "j",
                                          "k", "l")
                    },
                    {
                        create_button_row("Caps", "y", "x", "c", "v", "b", "n",
                                          "m", "Spc", "Ret", "Del")
                    },
